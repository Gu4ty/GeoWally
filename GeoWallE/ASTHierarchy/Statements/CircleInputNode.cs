...
{
    public class CircleInputNode:InputStatNode
    {
        public CircleInputNode(string id, Compiling.CodeLocation location)
        {
            identifier = id;
        ...
        {
            GeoObject circle;
            manager.Scan(typeof(GeoCircle), out circle,identifier);
            
            context.Define(identifier, circle);
            return true;
        }

...
{
    class LEqualParser : IInfixOperatorParser
    {
        public LEqualParser(TopDownParser parser)
        {
            Register(parser);
        }
        ...
        public ExpressionNode Parse(TopDownParser parser, ExpressionNode left, Token token)
        {
            ...
            return new OperatorNode(TokenValues.LessOrEquals, token.Location, left, right);
        }

        public void Register(TopDownParser parser)
        {
            parser.RegisterInfixParserByValue(TokenValues.LessOrEquals,this);
        }
    }
}

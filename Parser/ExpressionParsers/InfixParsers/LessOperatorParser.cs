...
{
    class LessOperatorParser : IInfixOperatorParser
    {
        public LessOperatorParser(TopDownParser parser)
        {
            Register(parser);
        }
        ...
        public ExpressionNode Parse(TopDownParser parser, ExpressionNode left, Token token)
        {
            ...
            return new OperatorNode(TokenValues.Less, token.Location, left, right);
        }

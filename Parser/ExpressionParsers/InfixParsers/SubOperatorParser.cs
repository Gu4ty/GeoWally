...
{
    class SubOperatorParser : IInfixOperatorParser
    {
        public SubOperatorParser(TopDownParser parser)
        {
            Register(parser);
        }
        ...
        public ExpressionNode Parse(TopDownParser parser, ExpressionNode left, Token token)
        {
            ...
            return new OperatorNode(TokenValues.Sub, token.Location, left, right);
        }

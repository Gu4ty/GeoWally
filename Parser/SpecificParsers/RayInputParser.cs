...
{
    public class RayInputParser : IInputStatementParser
    {

        public RayInputParser(InputParser parser)
        {
            Register(parser);
        }
        public StatementNode Parse(TopDownParser parser)
        {
            ...
            if (!parser.MatchValue(TokenValues.Ray))
                return null;
            string identifier;
            ...
            return new RayInputNode(identifier, token.Location);
        }

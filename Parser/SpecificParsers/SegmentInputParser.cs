...
{
    public class SegmentInputParser : IInputStatementParser
    {

        public SegmentInputParser(InputParser parser)
        {
            Register(parser);
        }
        public StatementNode Parse(TopDownParser parser)
        {
            ...
            if (!parser.MatchValue(TokenValues.Segment))
                return null;
            string identifier;
            ...
            return new SegmentInputNode(identifier, token.Location);
        }
